...
@XmlSeeAlso({
    NotSearchCriterion.class,
    UserAttributeCriterion.class,
    UserIdFilterCriterion.class,
    MemberOfGroupCriterion.class,
    UserIdCriterion.class,
    SearchCriterions.class
})
