...
public class UserManagementService extends Service {
    ...
    static {
        URL url = UserManagementService.class.getResource("https://192.168.21.69/portal/ws/com.orchestral.portal.webservice.api_7_2.user.UserManagementService?wsdl");
        if (url == null) {
            url = UserManagementService.class.getClassLoader().getResource("https://192.168.21.69/portal/ws/com.orchestral.portal.webservice.api_7_2.user.UserManagementService?wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(UserManagementService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "https://192.168.21.69/portal/ws/com.orchestral.portal.webservice.api_7_2.user.UserManagementService?wsdl");
        }       
        WSDL_LOCATION = url;
    }
